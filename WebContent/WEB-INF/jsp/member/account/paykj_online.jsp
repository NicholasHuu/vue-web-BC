    ...
    <div class="panel-content font-hei">
      <div class="page-title clear">
        <div class="left">
          ...
          <p class="mt5 gray">扫一扫自动到帐，更简单、更快捷！</p>
        </div>
      ...
      <div class="page-body switch-mod">
        <div class="switch-group">
          ...
          <div class="switch-item">
            ...
            <iframe id="payifram" name="payifram" frameborder="0" src="${ctx}/pay/paykjSelect?paytype=${paytype}&payid=${payid}&kjid=${kjid}" class="mt20 s14" style="width: 100%;height: 500px;"></iframe>
          </div>
          <!-- /item -->
        </div>
        <!-- /group -->
