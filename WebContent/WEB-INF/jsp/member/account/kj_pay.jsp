...
<div class="page-title clear">
	<div class="left">
		...
		<p class="mt5 gray">扫一扫轻松入款，同时还享受存款优惠！</p>
	</div>
...
<div class="page-body switch-mod">
	<div class="switch-group">
		<div class="switch-item" align="center" style="padding-top: 10px;">
			<p style="font-size: 16px;">请认真核实收款方昵称/账号！</p></br>
			<img alt="二维码" src="${ctx}/member/getPayImg?paytype=${pay.payType}" width="200" height="200">
            <p><span style="font-size: 14px; color: red;">${pay.payRname}</span></p></br>
		</div>
		<!-- /item -->
	</div>
	<!-- /group -->
							...
							<table class="mt20 s14">
								...
								<tr>
									...
									<td class="s12" align="left"> 
										...
										<span class="pl10 s12 gray">最低入款：${pay.minPay }元</span>
									</td>
								</tr>
								<tr>
									<td class="pr20 ar gray-dark"><label for="rechargeName">姓名</label></td>
									<td class="s12" align="left"  > 
								...
								<tr>
									...
									<td>
										...
										<input type="hidden" name="payType" id="payType" value="${pay.payType}" /> 
										<input type="hidden" name="minPay" id="minPay" value="${pay.minPay }" /> 
