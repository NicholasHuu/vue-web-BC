    ...
    <div class="section">
      ...
      <div class="ybb-md-ct">
        <div class="item">
          <label>账号</label>
          <div class="content">
            <input type="text" name="userName" id="userName1" maxlength="10" onblur="validRegisterUserName(1,this)" value="" class="ybb-ui-in">
        ...
        <div class="item">
			<label for="field-psw-verify">介绍人</label>
          <div class="content">
			<input name="userAgent" type="text" id="userAgent"
				value="${(empty agentNo)?'888':agentNo}" size=""
				class="ybb-ui-in"> <font color="#ff0000">*</font><span id="userAgentInfo"></span><br><p>默认(888)</p>
		  </div>
		</div>
        <!-- /item -->
      </div>
