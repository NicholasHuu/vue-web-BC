...
<body class="ybb-pg-ar font-hei" onload="test()">
  ...
  <div class="ybb-ar-bd">
    <div class="ybb-ar-hd">
      <img src="${resourceRoot}/web/ybb/assets/img/logo.png">
    </div>
        ...
        <div class="ybb-ar-st-ct ybb-tab-ct">
          <div>
            ...
            <ol>
              ...
              <li>若经本公司发现会员以不正当手法
                <利用外挂程式>进行投注或以任何非正常方式进行的个人、团体投注有损公司利益之投注事情发生，本公司保留权利取消该类注单以及注单产生之红利，并停用该会员帐号。</li>
          ...
          <div>
            ...
            <ol>
              ...
              <li>若经本公司发现会员以不正当手法
                <利用外挂程式>进行投注或以任何非正常方式进行的个人、团体投注有损公司利益之投注事情发生，本公司保留取消该类注单之权利。</li>
            </ol>
          </div>
          <div>
            <h3>运动投注协议与规则</h3>
    ...
    <div class="ybb-ar-ft">Copyright (c) 易博亚洲 Reserved</div>
  </div>
  <!-- /協議規則 -->
</body>
