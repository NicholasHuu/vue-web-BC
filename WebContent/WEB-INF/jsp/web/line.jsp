...
<head>
  ...
  <link rel="stylesheet" href="${resourceRoot}/web/modules/line/css/normalize.css">
  <link rel="stylesheet" href="${resourceRoot}/web/modules/line/css/font.css">
  <link rel="stylesheet" href="${resourceRoot}/web/modules/line/css/icons/flaticon.css">
  <link rel="stylesheet" href="${resourceRoot}/web/modules/line/css/animate.css">
  <link rel="stylesheet" href="${resourceRoot}/web/modules/line/css/line.css">
  <link rel="shortcut icon" href="${resourceRoot}/web/ybb/assets/img/favicon.ico" type="image/vnd.microsoft.icon" />
<style type="text/css">
  #logo{
  margin-top: 3px;
  width: 361px;
  ...
  <div class="wrapper font-hei">
    <div class="assist-line-header">
      <div class="inner clear">
		...
		<a href="/" id="logo"><img style="margin-top: 10px" src="${resourceRoot}/web/ybb/assets/img/logo.png" width="${ctxMap['lckLogoWidth'] }" height="${ctxMap['lckLogo_height'] }"></a>
          </h1>
        <div class="assist-line-header-tips ar white">
          <h2 class="pt30 s40">
            <span class="s20">欢迎莅临</span> <span class="yellow">${ctxMap['lckMainDomain'] }</span>
          </h2>
          <h3 class="pt10 s16 gray">
            如果线路检测对您有帮助，点击：
            <a href="javascript:void(0);" id="addToF" style="color: red"
    ...
    <div class="assist-line-container pt20">
      <div class="inner clear">
        <div class="assist-line-main left">
          <div class="content">
            <div class="assist-line-main-tips s14 yellow">${ctxMap['lckMainContent'] }</div>
...
<script type="text/javascript">
  ...
  run();
        ...
        <div class="assist-line-sidebar right wow fadeInLeft" data-wow-delay=".9s">
          <div class="item item-one item-myip al wow fadeInLeft" data-wow-delay=".3s">
          ...
          <div class="item item-style-two item-cache al wow fadeInLeft" data-wow-delay=".4s">
            <div class="text">
              <h6 class="s24 yellow">如何清除缓存</h6>
              <p class="pt10 white">操作步骤：打开<span class="yellow">IE浏览器</span>：选择：<span class="yellow">工具</span>-》<span class="yellow">Internet选项</span>-》在选择 <span class="yellow">(删除历史浏览记录)</span>-》<span class="yellow">删除</span>-》<span class="yellow">重启IE</span></p>
            </div>
            <div class="bg-alpha"></div>
          </div>
          <div class="item item-last item-service al wow fadeInLeft" data-wow-delay=".5s">
            <div class="text">
              <h6 class="s24 yellow">联系在线客服</h6>
              <p class="pt10 white">如果以上方式仍未解决您的问题，请联系官方线路人员远程协助您。</p>
              <a href="${ctxMap['msg007'] }" target="_blank" class="assist-line-btn mt10 center white">联系客服</a>
            </div>
            <div class="bg-alpha"></div>
          </div>
    ...
    <div class="assist-line-footer">
      <div class="inner">
        <div class="assist-line-contact pt20">
          <ul class="clear">
            <li class="clear">
              <i class="left flaticon-qq3 s60 white"></i>
              <h6 class="left pl10 s16 al white">QQ客服<br><a style="color: white" href="tencent://message/?uin=${ctxMap['siteQq'] }&Site=web&Menu=yes" target="_blank">${ctxMap['siteQq'] }</a></h6>
            </li>
            <li class="clear">
              <i class="left flaticon-2440 s60 white"></i>
              <h6 class="left pl10 s16 al white">免费热线<br>${ctxMap['siteTel'] }</h6>
            </li>
            <li class="clear">
              <i class="left flaticon-phone72 s60 white"></i>
              <h6 class="left pl10 s16 al white">国际电话<br>${ctxMap['siteMobile'] }</h6>
            </li>
            <li class="clear">
              <i class="left flaticon-chat81 s60 white"></i>
              <h6 class="left pl10 s16 al white"><a href="${ctxMap['msg007'] }" style="color: white" target="_blank">在线客服<br>7x24小时为你服务</a></h6>
            </li>
          </ul>
        </div>
