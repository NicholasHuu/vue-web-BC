									...
									<c:choose>
										<c:when test="${!empty webUser}">
											<a href="javascript:void(0);" target="_blank"
												onclick="winOpen('${ctx}/forwardGame?type=101&gameType=sun&gamecode=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','sun');" href="javascript:void(0);"
  ...
  <div class="container">
    <c:if test="${gameType1 eq 'all' || gameType1 eq null}">
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${sun_all['Slot'] }" var="item">
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${sun_all['Card games'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=bbin&gameid=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','bbin');return false;" href="javascript:void(0);" target="_blank" class="ui-link">${item.eleGameCnname }</a>
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${sun_all['Video Poker'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${sun_all['Table games'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=bbin&gameid=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','bbin');return false;" href="javascript:void(0);" target="_blank" class="ui-link">${item.eleGameCnname }</a>
    ...
    <c:if test="${gameType1 eq 'Table'}">
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${sun_all['Arcade'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=bbin&gameid=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','bbin');return false;" href="javascript:void(0);" target="_blank" class="ui-link">${item.eleGameCnname }</a>
