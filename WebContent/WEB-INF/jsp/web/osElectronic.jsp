...
<body class="ybb-web ybb-slot-bd slot slot-os">
							...
							<c:forEach var="item" items="${result}" varStatus="status">
								...
								<div class="col-sm-4 ui-item">
									...
									<div class="row row-btn">
										...
										<div class="col-sm-6 ui-item-son">
											<a href="javascript:void(0);" target="_blank"
												onclick="comeToOpen('${ctx}/test/forwardGame?gameType=osElectronicFun&gameName=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','os');return false;">免费试玩</a>
										</div>
									</div>
									<!-- / 网格视图 -->
									<!-- 列表视图 -->
	...
	<div class="ui-mod mod-slot-map">
		...
		<c:if test="${gameType1 eq 'all'  || gameType1 eq null }">
			...
			<div class="ui-group">
				...
				<div class="ui-mod-body">
					<ul class="row cf">
						<c:forEach items="${os_all['Slots'] }" var="item">
							<li class="col-sm-2 ui-item"><c:choose>
									...
									<c:otherwise>
										<a href="javascript:void(0);" data-toggle="modal"
														data-target=".modal-login" title="登录" class="ui-link">${item.eleGameCnname}</a>
									</c:otherwise>
								</c:choose></li>
						</c:forEach>
					</ul>
			...
			<div class="ui-group">
				...
				<div class="ui-mod-body">
					<ul class="row cf">
						<c:forEach items="${os_all['Card'] }" var="item">
							<li class="col-sm-2 ui-item"><c:choose>
									<c:when test="${!empty webUser}">
										<a href="javascript:void(0);" target="_blank"
														onclick="winOpen('${ctx}/forwardGame?gameType=osElectronicReal&gameName=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','os');return false;"
			...
			<div class="ui-group">
				...
				<div class="ui-mod-body">
					<ul class="row cf">
						<c:forEach items="${os_all['Table'] }" var="item">
							<li class="col-sm-2 ui-item"><c:choose>
									<c:when test="${!empty webUser}">
										<a href="javascript:void(0);" target="_blank"
														onclick="winOpen('${ctx}/forwardGame?gameType=osElectronicReal&gameName=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','os');return false;"
			...
			<!-- 分类 -->
			<div class="ui-group">
				<div class="ui-mod-head">电玩扑克</div>
				<div class="ui-mod-body">
					<ul class="row cf">
						<c:forEach items="${os_all['Video'] }" var="item">
							<li class="col-sm-2 ui-item"><c:choose>
									<c:when test="${!empty webUser}">
										<a href="javascript:void(0);" target="_blank"
														onclick="winOpen('${ctx}/forwardGame?gameType=osElectronicReal&gameName=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','os');return false;"
			...
			<div class="ui-group">
				...
				<div class="ui-mod-body">
					<ul class="row cf">
						<c:forEach items="${os_all['Scratch'] }" var="item">
							<li class="col-sm-2 ui-item"><c:choose>
									<c:when test="${!empty webUser}">
										<a href="javascript:void(0);" target="_blank"
														onclick="winOpen('${ctx}/forwardGame?gameType=osElectronicReal&gameName=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','os');return false;"
		...
		<c:if test="${gameType1 eq 'Scratch'}">
			<!-- 分类 -->
			<div class="ui-group">
				<div class="ui-mod-head">街机游戏</div>
				<div class="ui-mod-body">
