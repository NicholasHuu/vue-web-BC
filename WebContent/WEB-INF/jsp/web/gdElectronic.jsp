									...
									<c:choose>
										<c:when test="${!empty webUser}">
											<a href="javascript:void(0);" target="_blank"
												...
												title="开始游戏" class="ui-icon lazy nwi"
										...
										<c:otherwise>
											<a href="javascript:void(0);" data-toggle="modal"
												data-target=".modal-login" title="登录" class="ui-icon lazy nwi"
												data-original="${item.eleGamePic}"
												style=" background-image: url(${resourceRoot}/web/ybb/assets/img/blank.png);background-size: 100%;background-position: 0px -6px;"></a>
										</c:otherwise>
									</c:choose>
  ...
  <div class="container">
    <c:if test="${gameType1 eq 'all'  || gameType1 eq null }">
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${gd_all['Table Game'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=gd&game=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','gd');return false;" target="_blank" class="ui-link">${item.eleGameCnname }</a>
                  </c:when>
                  <c:otherwise>
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${gd_all['Slot Game'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=gd&game=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','gd');return false;" target="_blank" class="ui-link">${item.eleGameCnname }</a>
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${gd_all['Arcade'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=gd&game=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','gd');return false;" target="_blank" class="ui-link">${item.eleGameCnname }</a>
      ...
      <div class="ui-group">
        ...
        <div class="ui-mod-body">
          <ul class="row cf">
            <c:forEach items="${gd_all['Video Poker'] }" var="item">
              <li class="col-sm-2 ui-item">
                <c:choose>
                  <c:when test="${!empty webUser}">
                    <a href="javascript:void(0);" title="开始游戏" onclick="winOpen('${ctx}/forwardGame?gameType=gd&game=${item.eleGameId}',window.screen.width,window.screen.height,0,0,'game','gd');return false;" target="_blank" class="ui-link">${item.eleGameCnname }</a>
    ...
    <c:if test="${gameType1 eq 'Table Game'}">
      <div class="ui-group">
        <div class="ui-mod-head">桌面游戏</div>
        <div class="ui-mod-body">
          <ul class="row cf">
    ...
    <c:if test="${gameType1 eq 'Slot Game'}">
      <div class="ui-group">
        <div class="ui-mod-head">老虎机</div>
        <div class="ui-mod-body">
          <ul class="row cf">
